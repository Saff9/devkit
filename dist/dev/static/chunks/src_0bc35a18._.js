...
"[project]/src/app/json-formatter/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JsonFormatter() {
    ...
    const formatJson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "JsonFormatter.useCallback[formatJson]": ()=>{
            try {
                if (!input.trim()) {
                    setOutput('');
                    setError('');
    ...
    const minifyJson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "JsonFormatter.useCallback[minifyJson]": ()=>{
            try {
                if (!input.trim()) {
                    setOutput('');
                    setError('');
    ...
    const validateJson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "JsonFormatter.useCallback[validateJson]": ()=>{
            try {
                if (!input.trim()) {
                    setError('');
                    setOutput('');
...
_s(JsonFormatter, "SQHnncbqdm5BQ8i6o8W3djT1lSo=");
_c = JsonFormatter;
var _c;
...
//# sourceMappingURL=src_0bc35a18._.js.map