...
"[project]/src/app/base64/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Base64Tool() {
    ...
    const [base64, setBase64] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const encode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Base64Tool.useCallback[encode]": ()=>{
            try {
                if (!text) {
                    setBase64('');
                    setError('');
    ...
    const decode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Base64Tool.useCallback[decode]": ()=>{
            try {
                if (!base64) {
                    setText('');
                    setError('');
    ...
    const encodeUnicode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Base64Tool.useCallback[encodeUnicode]": ()=>{
            try {
                if (!text) {
                    setBase64('');
                    setError('');
                ...
                const encoded = btoa(encodeURIComponent(text).replace(/%([0-9A-F]{2})/g, {
                    "Base64Tool.useCallback[encodeUnicode].encoded": (_, p1)=>String.fromCharCode(parseInt(p1, 16))
                }["Base64Tool.useCallback[encodeUnicode].encoded"]));
                setBase64(encoded);
                setError('');
            } catch (err) {
    ...
    const decodeUnicode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Base64Tool.useCallback[decodeUnicode]": ()=>{
            try {
                if (!base64) {
                    setText('');
                    setError('');
                ...
                const decoded = decodeURIComponent(atob(base64).split('').map({
                    "Base64Tool.useCallback[decodeUnicode].decoded": (c)=>'%' + ('00' + c.charCodeAt(0).toString(16)).slice(-2)
                }["Base64Tool.useCallback[decodeUnicode].decoded"]).join(''));
                setText(decoded);
                setError('');
            } catch (err) {
                setError('Decoding failed: Invalid Base64 string');
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Base64 Encoder/Decoder"
                    }, void 0, false, {
                        fileName: "[project]/src/app/base64/page.tsx",
                        lineNumber: 74,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-gray-600 dark:text-gray-400",
                        children: "Encode and decode Base64 strings. Supports both ASCII and Unicode text."
                    }, void 0, false, {
                        fileName: "[project]/src/app/base64/page.tsx",
                        lineNumber: 77,
                        columnNumber: 9
...
_s(Base64Tool, "DpQaHUECfPhYIolG/N8K8ufEhgA=");
_c = Base64Tool;
var _c;
...
//# sourceMappingURL=src_7f31a07a._.js.map